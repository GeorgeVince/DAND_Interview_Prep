# -*- coding: utf-8 -*-
"""
Created on Wed Sep 13 16:10:39 2017
...
Let's assume that a song consists of some number of words. To make the dubstep 
 of this song, Polycarpus inserts a certain number of words "WUB" before the 
 first word of the song (the number may be zero), after the last word (the number
 may be zero), and between words (at least one between any pair of neighbouring words),
 and then the boy glues together all the words, including "WUB", in one string and 
...
into modern music, he decided to find out what was the initial song that Polycarpus 
...
def song_decoder(song):
    ...
    to_return = " ".join(song.replace("WUB", " ").strip().split())
    return to_return  



print (song_decoder("WUBWEWUBAREWUBWUBTHEWUBCHAMPIONSWUBMYWUBFRIENDWUB"))
print (song_decoder("AREWUBWUBTHEWUBCHAMPIONSWUBMYWUBFRIENDWUB"))